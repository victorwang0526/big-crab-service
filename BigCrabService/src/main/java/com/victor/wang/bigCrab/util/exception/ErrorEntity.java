...
public class ErrorEntity
{
	...
	/**
	 * The error code for this error i.e: com.victor.wang.bigCrab.duplicate_display_name. This is intended to be uses by
	...
	/**
	 * The error code for this error i.e: com.victor.wang.bigCrab.login.duplicate_display_name. This is intended to be uses by
	 * applications to map the error to an internationalized message within the app.
	 *
