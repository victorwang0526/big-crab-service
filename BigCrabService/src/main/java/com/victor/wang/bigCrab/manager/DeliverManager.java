...
//		dto.setConsignerShipperCode("518052"); //收件人邮政编码（国际件必传）
...
//        }
    ...
    public SfPrintInfo WayBillPrinterTools(String a){
        SfPrintInfo sfPrintInfo = new SfPrintInfo();
/*********2联150 丰密运单**************/
        /**
...
//            httpConn.setRequestProperty("Content-Type", "text/plain;charset=utf-8");
        ...
        //这个必填
        dto.setAppId(this.clientCode);//对应clientCode
        dto.setAppKey(this.checkWord);//对应checkWord
